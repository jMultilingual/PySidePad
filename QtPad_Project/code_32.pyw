...
##        self.alignLeftToolButton.toggled.connect(
##            t.setAlignment
##            )
##        self.alignCenterToolButton.toggled.connect(
##            t.setAlignment
##            )
##        self.alignRightToolButton.toggled.connect(
##            t.setAlignment
##            )
##        self.alignJustifyToolButton.toggled.connect(
##            t.setAlignment
##            )
