...
class WidgetAction(QWidgetAction):
    ...
    backgroundColorLabelPress = Signal(QLabel)#new

    def __init__(self, parent=None):
        super().__init__(parent)

        self.setDefaultWidget(TextColorWidget())#new

    def createWidget(self, widget):#new↓
    ...
    def eventFilter(self, obj, event):
        ...
        if (event.type() == QEvent.MouseButtonPress):
            ...
            elif objectName == "BackgroundColorWidget":#new↓
...
class BackgroundColorWidget(QWidget, Ui_BackgroundColorWidget):#new↓
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.backgroundColorMenu = QMenu(objectName="backgroundColorMenu")#new
        self.backgroundColorMenu.addAction(self.widgetAction)#new
        self.backgroundColorMenuToolButton.setMenu(self.backgroundColorMenu)#new
        ...
        self.noColorAction = QAction("色なし(&N)", triggered=t.clearBackground)#new
        self.backgroundColorMenu.addAction(self.widgetAction)#new
        self.backgroundColorMenu.addAction(self.noColorAction)#new
        self.backgroundColorMenuToolButton.setMenu(self.backgroundColorMenu)#new
