...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.fontUpperToolButton.clicked.connect(t.crementPointSize)#new
        self.fontDownerToolButton.clicked.connect(t.crementPointSize)#new  
def main():
